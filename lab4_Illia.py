...
def convert_american_dollars(american_dollars):
    ...
    return round(canadian_dollar, 2)
...
def alarm_time(current_time_string, waiting_time_string):
    hours = int(current_time_string) + int(waiting_time_string)
    timeofday = hours % 24
    return timeofday
...
assert average([2, 3, 5]) == 3.33
assert average([2, 3, 8]) == 4.33
assert average([2, 3, 12]) == 5.67
...
# Write and pass your units tests (5 marks)
assert find_max([2, 8, 9, 24, 4]) == 24
assert find_max([2, 28, 9, 24, 4]) == 28
assert find_max([41, 8, 9, 24, 4]) == 41
...
# Write and pass your units tests (5 marks)
assert evens([2, 4, 3, 5, 8, 10, 11]) == [2, 4, 8, 10]
assert evens([2, 4, 3, 5, 8, 10, 11, 6, 20]) == [2, 4, 8, 10, 6, 20]
assert evens([2, 4, 3, 5, 8, 10, 11, 20, 22, 23, 24]) == [2, 4, 8, 10, 20, 22, 24]
...
assert sum_of_squares([2, 3, 5]) == 38
assert sum_of_squares([2, 5, 10]) == 129
...
assert squares([1, 5, 6, 7]) == [1, 25, 36, 49]
assert squares([1, 2, 3, 100]) == [1, 4, 9, 10000]
