...
side_1 = 3
side_2 = 4
print("I think the area of the rectangle is:", side_1 * side_2) # This line prints a f-string, including variables in a string.
...
my_name = "Illia" # Change to your name
my_github_account = "https://github.com/IlliaDabbagh/comp115" # Change to your GitHub account
my_hobby = "boxing" # Change to your hobby
...
project_another_interested = project_types[0] # Try to change the index from 3 to 4, and run the program :)
